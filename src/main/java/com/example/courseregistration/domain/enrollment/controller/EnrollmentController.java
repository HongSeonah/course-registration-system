...
public class EnrollmentController {
    ...
    public List<EnrollmentResponse> findMyEnrollments(@PathVariable Long userId) {
        return enrollmentService.findMyEnrollments(userId);
    }
    ...
    public List<EnrollmentResponse> findByCourseClass(@PathVariable Long courseClassId) {
        return enrollmentService.findByCourseClass(courseClassId);
    }
}
